...
const products = [
  {
    ...
    description: 'Secure document integrity and chain of custody. Every artifact gets a Digital Notary certificate for legal defensibility.',
    capabilities: [
      'Multi-format document ingestion',
      'SHA-256 cryptographic verification',
      'Digital Notary certificates',
  ...
  },
  {
    icon: Network,
    name: 'Nautica',
    subtitle: 'The Intelligence Nexus',
    description: 'Unmasks fraud networks and entity risk. Pre-Submission Risk signals detect fraud before it reaches consulates.',
    capabilities: [
      'Cross-consulate pattern matching',
      'Visa mill network detection',
      'Pre-Submission Risk (Vizesepetim)',
  ...
  },
  {
    ...
    description: 'Instant policy distribution and governance. Case Management Workspace for consular officer review.',
    capabilities: [
      '60-second global policy sync',
      'Case Management Workspace',
      'Offline/On-Prem capability',
      'Sovereignty Engine',
    ],
  },
];
